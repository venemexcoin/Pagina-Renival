                        ...
                        @if (Auth::user()->utype === 'ADM')
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="#"><span class="item-text"
                                            title="Dashboard">Adminitracion
                                        </span></a>
                        ...
                        @elseif(Auth::user()->utype === 'WRK')
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle page-scroll" href="#about" id="navbarDropdown"
                                    ...
                                    ({{ Auth::user()->name }})</a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="#"><span class="item-text" title="Dashboard">
                                            Worker</span></a>
                                    <div class="dropdown-items-divide-hr"></div>
                    ...
                    <div class="row">
                        {{-- <div class="col-lg-6">
                            <div class="text-container">
                                ...
                                @if (Route::has('login'))
                                    @if (Auth::user())
                                        <a class="btn-solid-lg page-scroll" href="#services">Programar reunión</a>
                                    @else
                        ...
                        <div class="col-lg-6">
                            <div class="image-container">
                                <img class="img-fluid"
                                    src="{{ asset('assets/images/illustrate/Data_Arranging_Flatline.svg') }}"
                                    alt="alternative">
